...
import { XMarkIcon, PaperAirplaneIcon, CheckBadgeIcon } from './icons';
...
const FloatingChatButton: React.FC = () => {
    ...
    return (
        <div ref={containerRef} className="fixed bottom-6 right-6 z-50">
            {/* Widget */}
            <div
                className={`w-80 sm:w-96 bg-gray-900 rounded-2xl shadow-2xl border border-white/10 transition-all duration-300 ease-in-out origin-bottom-right ${
