...
export const SERVICES: Service[] = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1542831371-29b0f74f9713?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600',
    rating: 4.9,
    reviewCount: 78,
    price: 450,
    ordersInQueue: 3,
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1626785774573-4b799315345d?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600',
    rating: 5.0,
    reviewCount: 52,
    price: 250,
    ordersInQueue: 5,
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1574717547378-74332d942189?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600',
    rating: 4.8,
    reviewCount: 45,
    price: 150,
    ordersInQueue: 2,
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1457369804613-52c61a468e7d?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600',
    rating: 4.9,
    reviewCount: 21,
    price: 200,
    ordersInQueue: 1,
  ...
  { id: 's5', freelancerId: 'f1', title: 'Développement d\'une API RESTful sécurisée', imageUrl: 'https://images.unsplash.com/photo-1587620962725-abab7fe55159?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600', rating: 4.9, reviewCount: 22, price: 300, ordersInQueue: 1, description: 'API robuste et documentée pour votre application.', features: ['Node.js/Express', 'Authentification JWT', 'Documentation Swagger'] },
  { id: 's6', freelancerId: 'f2', title: 'Design d\'interface pour application mobile (UI/UX)', imageUrl: 'https://images.unsplash.com/photo-1581287053822-fd7bf4f4bf3f?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600', rating: 5.0, reviewCount: 31, price: 600, ordersInQueue: 2, description: 'Une expérience utilisateur fluide et un design attractif.', features: ['Fichiers Figma', 'Prototype cliquable', 'Jusqu\'à 10 écrans'] },
  { id: 's7', freelancerId: 'f3', title: 'Animation de logo (intro/outro)', imageUrl: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600', rating: 4.9, reviewCount: 19, price: 100, ordersInQueue: 4, description: 'Donnez vie à votre logo avec une animation professionnelle.', features: ['Animation 5-10s', 'Musique & effets sonores', 'Format 4K'] },
  { id: 's8', freelancerId: 'f2', title: 'Création de bannières publicitaires pour le web', imageUrl: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600', rating: 4.9, reviewCount: 15, price: 80, ordersInQueue: 3, description: 'Visuels percutants pour vos campagnes publicitaires.', features: ['3 tailles de bannières', 'Formats JPG/PNG/GIF', '2 révisions'] },
  { 
    id: 's9', 
    freelancerId: 'f4', 
    title: 'Je vais réaliser un audit SEO complet de votre site web', 
    imageUrl: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600', 
    rating: 4.9, 
    reviewCount: 28, 
    price: 350, 
    ordersInQueue: 2, 
  ...
  { 
    ...
    imageUrl: 'https://images.unsplash.com/photo-1611162617213-6d22e4f13374?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=600', 
    rating: 5.0, 
    reviewCount: 41, 
    price: 180, 
    ordersInQueue: 3, 
...
export const REVIEWS: Review[] = [
    { id: 'r1', authorName: 'Ibrahim Diallo', authorAvatarUrl: 'https://randomuser.me/api/portraits/men/7.jpg', rating: 5, comment: 'Excellent travail ! Ayoub est très professionnel, communicatif et a livré un site web impeccable bien avant la date limite. Je referai appel à lui sans hésiter.', date: 'il y a 2 semaines' },
    { id: 'r2', authorName: 'Khadija S.', authorAvatarUrl: 'https://randomuser.me/api/portraits/women/8.jpg', rating: 5, comment: 'Très satisfait du site web. Le design est moderne et les fonctionnalités correspondent parfaitement à mes attentes.', date: 'il y a 1 mois' },
    { id: 'r3', authorName: 'Moussa Traoré', authorAvatarUrl: 'https://randomuser.me/api/portraits/men/9.jpg', rating: 4, comment: 'Bonne collaboration dans l\'ensemble. Quelques petits ajustements ont été nécessaires mais le résultat final est de qualité.', date: 'il y a 3 mois' },
];
